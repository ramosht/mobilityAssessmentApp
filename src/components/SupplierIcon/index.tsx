...
const SupplierIcon: React.FC<SupplierIconProps> = ({ supplierName, size }) => {
  ...
  return (
    <>
      {supplierName === 'Bolt' && colorScheme === 'dark' && <BoltLight height={size} />}
      {supplierName === 'Bolt' && colorScheme === 'light' && <BoltDark height={size} />}
      {supplierName === 'FREENOW' && colorScheme === 'dark' && <FreenowLight height={size} />}
      {supplierName === 'FREENOW' && colorScheme === 'light' && <FreenowDark height={size} />}
    </>
  );
};
